...
CodeMirror.defineMode("sql", function(config, parserConfig) {
  ...
  function tokenBase(stream, state) {
    ...
    if (support.hexNumber == true &&
      ...
      if (word == "update") return "error";
      if (word == "delete") return "error";
      if (word == "drop") return "error";
      if (word == "alter") return "error";
      if (word == "insert") return "error";
      if (word == "create") return "error";
...
(function() {
  ...
  var errorKeywords = ["alter", "update", "delete", "insert", "drop"];
